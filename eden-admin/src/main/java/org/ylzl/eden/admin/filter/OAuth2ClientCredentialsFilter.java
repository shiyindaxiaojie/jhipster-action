...
package org.ylzl.eden.admin.filter;
...
public class OAuth2ClientCredentialsFilter extends ZuulFilter {
	...
	public OAuth2ClientCredentialsFilter(ClientCredentialsTokenHolder clientCredentialsTokenHolder,
    ...
    public boolean shouldFilter() {
		...
		return pathMatcher.match(adminServerProperties.getContextPath() + "/instances/**", requestURI);
    }
}
